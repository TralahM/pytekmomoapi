...
class RemoteCaller:
    ...
    def token_POST(
        ...
        :return: OK
        """
        url = self.url_prefix + "/disbursement/token/"
    ...
    def get_v1_0_account_balance(
        ...
        :return: Ok
        """
        url = self.url_prefix + "/disbursement/v1_0/account/balance"
    ...
    def get_v1_0_accountholder_accountholderidtype_accountholderid_active(
        ...
        :param ocp_apim_subscription_key: Subscription key which provides access to this API.
        :param account_holder_id: The party number. Validated according to the party id type. <br> MSISDN - Mobile Number validated according to ITU-T E.164. Validated with IsMSISDN<br> EMAIL - Validated to be a valid e-mail format. Validated with IsEmail<br> PARTY_CODE - UUID of the party. Validated with IsUuid
        :param account_holder_id_type: Specifies the type of the party id. Allowed values [msisdn, email, party_code].
        :param x_target_environment: The identifier of the EWP system where the transaction shall be processed. This parameter is used to route the request to the EWP system that will initiate the transaction.
        :param authorization: Authorization header used for Basic authentication and oauth. Format of the header parameter follows the standard for Basic and Bearer. Oauth uses Bearer authentication type where the credential is the received access token.

        :return: Ok. True if account holder is registered and active, false if the account holder is not active or not found found
        """
        url = "".join(
            [
                self.url_prefix,
                "/disbursement/v1_0/accountholder/",
    ...
    def transfer_POST(
        ...
        :param ocp_apim_subscription_key: Subscription key which provides access to this API.
        :param x_reference_id: Format - UUID. Recource ID of the created ‘request-to-pay’ transaction. This ID is used for e.g. validating the status of the request. Universal Unique ID for the transaction generated using UUID version 4.
        :param x_target_environment: The identifier of the EWP system where the transaction shall be processed. This parameter is used to route the request to the EWP system that will initiate the transaction.
        :param authorization: Authorization header used for Basic authentication and oauth. Format of the header parameter follows the standard for Basic and Bearer. Oauth uses Bearer authentication type where the credential is the received access token.
        ...
        :return:
        """
        url = self.url_prefix + "/disbursement/v1_0/transfer"
        ...
        if transfer != None:
            data = to_jsonable(transfer, expected=[Transfer])
    ...
    def transfer_referenceId_GET(
        ...
        :return: OK. Note that a failed transfer will be returned with this status too. The 'status' of the TransferResult can be used to determine the outcome of the request. The 'reason' field can be used to retrieve a cause in case of failure.
        """
        url = "".join(
            [self.url_prefix, "/disbursement/v1_0/transfer/",
                str(reference_id)]
        )
        ...
        with contextlib.closing(resp):
            resp.raise_for_status()
            return from_obj(obj=resp.json(), expected=[TransferResult])
