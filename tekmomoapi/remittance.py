...
class RemoteCaller:
    ...
    def token_POST(
        ...
        :return: OK
        """
        url = self.url_prefix + "/remittance/token/"
    ...
    def get_v1_0_account_balance(
        ...
        :return: Ok
        """
        url = self.url_prefix + "/remittance/v1_0/account/balance"
    ...
    def transfer_POST(
        ...
        :return:
        """
        url = self.url_prefix + "/remittance/v1_0/transfer"
    ...
    def transfer_referenceId_GET(
        ...
        """
        url = "".join(
            [self.url_prefix, "/remittance/v1_0/transfer/", str(reference_id)]
        )
